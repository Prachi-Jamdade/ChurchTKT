...
const CONTENT = [
  ...
  },
  {
    ...
    sub_category: [
      {
        id: 2,
        val: "We host our services every friday and sunday at Clock Tower Second Bazaar Maruthi Veedhi, Shivaji Nagar, Hyderabad, Telangana 500003. Can't wait to worship with you.",
      },
    ],
  },
];
...
const OpenWhatsApp = () => {
  let url = 'whatsapp://send?text=' + '' + '&phone=91' + '7993478539';
  Linking.openURL(url)
    .then(data => {
        ...
        <SafeAreaView
          ...
          <SafeAreaView
            ...
            <Text
              ...
              If you are stuck somewhere, we have got you covered
            </Text>
