...
const Profile = ({navigation}) => {
  const {setAlert, isUserLogin, user, setUser, profileUrl, setProfileUrl} =
  ...
  return (
    <SafeAreaView
      ...
      <Text
        style={[
          gobalStyle.header,
          {alignSelf: 'flex-start', marginBottom: RFValue(20)},
        ]}>
        Profile
      </Text>
      ...
      <SafeAreaView
        ...
        <TouchableHighlight
          ...
          <ProfileComponent
            imgSource={{type: Icons.AntDesign, name: 'adduser'}}
            componentName="Help"
          />
        </TouchableHighlight>
        ...
        <TouchableHighlight
          ...
          <ProfileComponent
            imgSource={{type: Icons.Feather, name: 'shield'}}
