    ...
    <SafeAreaView
      ...
      <ScrollView
        ...
        <Text style={styles.DescriptionText}>
          Partnering with samuel patta ministries is a powerful way to expand
          the reach and impact of the King's Temple Church. No matter how you
          choose to give, your support is invaluable in helping the ministry to
          achieve its goals and make a positive impact in the world.
        </Text>
        <Text style={styles.DescriptionText}>
          So, if you are considering partner with us, know that your support is
          greatly appreciated and will make a real difference in the lives of
          others. By giving generously and faithfully, you can help to advance
          the work of the church and bring more people into a relationship with
          Christ.
        </Text>
        <TouchableHighlight onPress={() => navigation.navigate('SpmOffErings')}>
          <SafeAreaView
            style={[
              {
                flexDirection: 'column',
                backgroundColor: '#4FF491',
