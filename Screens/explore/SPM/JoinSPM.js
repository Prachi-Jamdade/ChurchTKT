      ...
      <ScrollView
        ...
        <SafeAreaView>
          <Text style={styles.boldText}>
            {!isDiabled ? 'Details' : 'We need some details'}
          </Text>
          ...
          {!isDiabled && <Text style={[styles.normalText]}>Name</Text>}
          ...
          {!isDiabled && <Text style={[styles.normalText]}>Father Name</Text>}
          <TextInput
            style={styles.input}
            underlineColorAndroid="transparent"
        ...
        {!route.params?.data && (
          <TouchableHighlight
            style={[
              gobalStyle.btn_abs,
              {position: 'relative', marginTop: RFValue(60)},
            ]}
            onPress={() => {
              submit();
            }}>
