...
const SendWhatsApp = () => {
    let msg = 'Hello, I would like to join a Life group. I want to know more about it. Can you please help me connect with a Life group co-ordinator?';
    let phoneWithCountryCode = '919542472448';
                ...
                <>
                    {
                        ...
                        :
                        <CommunityBox navigation={navigation} {...data[index]} setIndex={setIndex} SendWhatsApp={SendWhatsApp}></CommunityBox>
                    }
                </>
            )
        }
